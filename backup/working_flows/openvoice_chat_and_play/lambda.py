...
def _synthesize_full_with_filler(event):
    ...
    try:
        ...
        if DISABLE_DDB:
            ...
            try:
                ...
                if head_response.get("ContentLength", 0) > 0:
                    ...
                    attrs = {
                        "ready": "true",
                        "AudioS3Url0": s3_url(job_bucket, f"{filler_category}/{filler_index:02d}.wav"),
                        "AudioS3UrlCount": "1",
                        "BatchCount": "1",
                        ...
                        "filler_index": str(filler_index),
                        "job_bucket": job_bucket,
                        "job_key": target_key,             # e.g. "connect/sessions/full_cache/<id>.wav"
                        "cache_hit": "false"
                    }
        ...
        cat, idx, filler_key, filler_url = _filler_key_url(filler_category, filler_index)
